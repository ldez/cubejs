...
(function() {
  var BL, BR, Cube, DB, DBL, DF, DFR, DL, DLF, DR, DRB, FL, FR, RotationCube, UB, UBR, UF, UFL, UL, ULB, UR, URF, cornerColor, cornerFacelet, edgeColor, edgeFacelet, faceNames, faceNums, ref, ref1, ref2;
  ...
  RotationCube = (function() {
    ...
    RotationCube.prototype.z = function() {
      var pastTopFace;
      pastTopFace = this.northFace;
    ...
    RotationCube.prototype.zPrime = function() {
      var pastTopFace;
      pastTopFace = this.northFace;
    ...
    RotationCube.prototype.y = function() {
      var pastFrontFace;
      pastFrontFace = this.frontFace;
    ...
    RotationCube.prototype.yPrime = function() {
      var pastFrontFace;
      pastFrontFace = this.frontFace;
    ...
    RotationCube.prototype.xPrime = function() {
      var pastFrontFace;
      pastFrontFace = this.frontFace;
    ...
    RotationCube.prototype.x = function() {
      var pastFrontFace;
      pastFrontFace = this.frontFace;
    ...
    RotationCube.prototype.translateMove = function(moveString) {
      var translateEnum;
      translateEnum = {
  ...
  Cube = (function() {
    ...
    Cube.prototype.parseAlg = function(arg) {
      ...
      if (typeof arg === 'string') {
        ...
        for (k = 0, len = ref3.length; k < len; k++) {
          ...
          move = faceNums[this.rotCube.translateMove(part[0])];
          if (move === void 0) {
            throw new Error("Invalid move: " + part);
          }
          if (part.length === 1) {
